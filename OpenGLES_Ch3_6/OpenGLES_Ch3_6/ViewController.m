...
- (void)viewDidLoad {
    ...
    ((AGLKContext *)view.context).clearColor = GLKVector4Make(0.65f, 0.65f, 0.65f, 1.0f);
...
-(void)update{
    ...
    baseModelViewMatrix = GLKMatrix4Rotate(baseModelViewMatrix, _rotation, 0.0f, 1.0f, 1.0f);
...
-(void)glkView:(GLKView *)view drawInRect:(CGRect)rect{
    ...
    glUniform1i(uniforms[UNIFORM_TEXTURE0_SAMPLER2D], 1);
...
- (BOOL)loadShaders{
    ...
    uniforms[UNIFORM_NORMAL_MATRIX] = glGetUniformLocation(_program, "uModelViewProjectionMatrix");
